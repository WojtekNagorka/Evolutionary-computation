...
public class Greedy2RegretHeuristicFlexibleNNRepairer extends TSPSolver {

    private final double regretWeight;

    public Greedy2RegretHeuristicFlexibleNNRepairer(double[][] distanceMatrix, List<Node> nodes, double regretWeight) {
